...
<head>
  ...
  <meta
    property="og:image"
    content="https://mauriciomutte.dev/Hello%20World.png"
  />
</head>
```
...
```tsx showLineNumbers title="options.tsx"
...
```tsx showLineNumbers title="chromium.tsx"
...
```ts showLineNumbers title="./pages/api/og.ts"
